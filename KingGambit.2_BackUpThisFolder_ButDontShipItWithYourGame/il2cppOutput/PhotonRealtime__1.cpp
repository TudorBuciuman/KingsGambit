...
IL_007d:
	...
	}
	{
		...
		Region_tD981338A8FBC28C39100FF9111854EC8ABE8619A* L_18 = __this->___region;
		NullCheck(L_18);
		String_t* L_19;
		L_19 = Region_get_Code_m25CDC61EBD0A1EDEA277235D87D55869A18B9122_inline(L_18, NULL);
		Region_tD981338A8FBC28C39100FF9111854EC8ABE8619A* L_20 = __this->___region;
		NullCheck(L_20);
		String_t* L_21;
...
IL_001a:
	...
	}
	{
		...
		__this->___RemovedFromList = ((*(bool*)((bool*)(bool*)UnBox(L_9, il2cpp_defaults.boolean_class))));
...
IL_008e:
	...
	}
	{
		...
		__this->___isOpen = ((*(bool*)((bool*)(bool*)UnBox(L_24, il2cpp_defaults.boolean_class))));
	}
...
IL_00b1:
	...
	}
	{
		...
		__this->___isVisible = ((*(bool*)((bool*)(bool*)UnBox(L_28, il2cpp_defaults.boolean_class))));
	}
...
IL_00f7:
	...
	}
	{
		...
		__this->___autoCleanUp = ((*(bool*)((bool*)(bool*)UnBox(L_37, il2cpp_defaults.boolean_class))));
	}
...
IL_011a:
	...
	}
	{
		...
		__this->___masterClientId = ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_41, il2cpp_defaults.int32_class))));
	}
...
IL_0183:
	...
	}
	{
		...
		__this->___emptyRoomTtl = ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_53, il2cpp_defaults.int32_class))));
	}
...
IL_01a6:
	...
	}
	{
		...
		__this->___playerTtl = ((*(int32_t*)((int32_t*)(int32_t*)UnBox(L_57, il2cpp_defaults.int32_class))));
	}
...
IL_0026:
	...
	}
	{
		...
		WebRpcResponse_set_ResultCode_mD491E392728861EB290022B46D419B4E49364191_inline(__this, ((*(uint8_t*)((uint8_t*)(uint8_t*)UnBox(L_7, il2cpp_defaults.byte_class)))), NULL);
	}
